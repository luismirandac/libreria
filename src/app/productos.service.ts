...
export class ProductosService {
  ...
  get dameProducto(){
    return this.lProductos // Sin "..." obtiene el original
  }

  get getProducto(){
    return [...this.lProductos] // "..." Para hacer copia
  }

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  lClientes = [
    { rut: "1-1", nombre: "Juan", appaterno: "gonzales", isEditing: true }
  ]
  ...
  get dameCliente(){
    return this.lClientes // Sin "..." obtiene el original
  }

  get getCliente(){
    return [...this.lClientes] // "..." Para hacer copia
  }

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  
    lSucursales = [
    { id: "1-1", nombre: "Juan", direccion: "gonzales", isEditing: true }
  ]
  
  dame_sucursal(){
    return this.lSucursales
  }

  get dameSucursal(){
    return this.lSucursales // Sin "..." obtiene el original
  }

  get getSucursal(){
    return [...this.lSucursales] // "..." Para hacer copia
  }
  constructor() { }
}
