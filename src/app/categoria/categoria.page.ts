...
export class CategoriaPage implements OnInit {
 ...
 toggleArtes() {
    this.showArtes = !this.showArtes;
  }
  toggleHistoria() {
    this.showHistoria = !this.showHistoria;
  }
  toggleCienciaficcion() {
    this.showCienciaficcion = !this.showCienciaficcion;
  }
  toggleDerecho() {
    this.showDerecho = !this.showDerecho;
  }
